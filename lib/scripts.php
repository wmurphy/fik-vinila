...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_vinila', get_template_directory_uri() . '/assets/css/vinila.css', false, '9880649384aea9f1ee166331c0a30daa');
  ...
  wp_register_script('responsive_menu', get_template_directory_uri() . '/assets/js/jquery.fs.naver.js', array(), null, false);
